...
import com.self.pro.learn.util.Base64Utils;
import com.self.pro.learn.util.GzipUtil;
...
//         String json1 = getJson(Paths.get("/Users/chenbin/test/old_cfecredito.json"));
//         String json2 =getJson(Paths.get("/Users/chenbin/test/new_cfecredito.json"));
//         String resultStr = new CompareJson("aws").compareJson(json1, json2);
//        System.out.println(resultStr);

        String jsonContent = getJson(Paths.get("/Users/chenbin/test/card_devicejson.json"));
        String data = GzipUtil.uncompressToString(Base64Utils.decode(jsonContent), "UTF-8");
        System.out.println(data);


    }
    private static String getJson (Path p1) {
        String j1 = "";
        try {
